...
String getFromDynamicMap(Varable v) {
  final type = v.type;
...
/*       bool1: map['bool1'] != null || true, 
    ...
    case EnumTypeVarable.map_int_dynamic_:
      if (yes_null_default_yes) {
        return " (Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(int.parse(k), e)) ?? $initComment";
      } else if (yes_null_default_no) {
        return " (Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(int.parse(k), e))";
      } else if (no_null_default_yes) {
        return " (Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(int.parse(k), e)) ?? $initComment";
      } else if (no_null_default_no) {
        return _getValueWithException(
          "(Map<String, dynamic>.from(map['$name'] as Map)).map( (k, e) => MapEntry(int.parse(k), e))",
          name,
        );
      }
      return error;
    ...
    case EnumTypeVarable.map_int_double:
      if (yes_null_default_yes) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(int.parse(k), (e as num).toDouble())) ?? $initComment";
      } else if (yes_null_default_no) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(int.parse(k), (e as num).toDouble()))";
      } else if (no_null_default_yes) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(int.parse(k), (e as num).toDouble())) ?? $initComment";
      } else if (no_null_default_no) {
        return _getValueWithException(
          "(Map<String, dynamic>.from(map['$name'] as Map)).map( (k, e) => MapEntry(int.parse(k), (e as num).toDouble()))",
          name,
        );
      }
      return error;
    ...
    case EnumTypeVarable.map_string_bool:
      if (yes_null_default_yes) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(k, e as bool)) ?? $initComment";
      } else if (yes_null_default_no) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(k, e as bool))";
      } else if (no_null_default_yes) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(k, e as bool)) ?? $initComment";
      } else if (no_null_default_no) {
        return _getValueWithException(
          "(Map<String, dynamic>.from(map['$name'] as Map)).map( (k, e) => MapEntry(k, e as bool))",
          name,
        );
      }
      return error;
    ...
    case EnumTypeVarable.map_:
      if (yes_null_default_yes) {
        return "Map<String, dynamic>.from(map['$name'] as Map)? ?? $initComment";
      } else if (yes_null_default_no) {
        return "Map<String, dynamic>.from(map['$name'] as Map)?";
      } else if (no_null_default_yes) {
        return "Map<String, dynamic>.from(map['$name'] as Map)? ?? $initComment";
      } else if (no_null_default_no) {
        return _getValueWithException(
          "Map<String, dynamic>.from(map['$name'] as Map)",
          name,
        );
      }
      return error;
    ...
    case EnumTypeVarable.map_string_string:
      if (yes_null_default_yes) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(k, e as String)) ?? $initComment";
      } else if (yes_null_default_no) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(k, e as String))";
      } else if (no_null_default_yes) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(k, e as String)) ?? $initComment";
      } else if (no_null_default_no) {
        return _getValueWithException(
    ...
    case EnumTypeVarable.map_string_int:
      if (yes_null_default_yes) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map( (k, e) => MapEntry(k, e as int)) ?? $initComment";
      } else if (yes_null_default_no) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map( (k, e) => MapEntry(k, e as int))";
      } else if (no_null_default_yes) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map( (k, e) => MapEntry(k, e as int)) ?? $initComment";
      } else if (no_null_default_no) {
        return _getValueWithException(
    ...
    case EnumTypeVarable.map_string_double_:
      if (yes_null_default_yes) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map( (k, e) => MapEntry(k, (e as num).toDouble())) ?? $initComment";
      } else if (yes_null_default_no) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map( (k, e) => MapEntry(k, (e as num).toDouble()))";
      } else if (no_null_default_yes) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map( (k, e) => MapEntry(k, (e as num).toDouble())) ?? $initComment";
      } else if (no_null_default_no) {
        return _getValueWithException(
          "(Map<String, dynamic>.from(map['$name'] as Map)).map((k, e) => MapEntry(k, (e as num).toDouble()))",
          name,
        );
      }
      return error;
    ...
    case EnumTypeVarable.map_int_bool:
      if (yes_null_default_yes) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(int.parse(k), e as bool)) ?? $initComment";
      } else if (yes_null_default_no) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(int.parse(k), e as bool))";
      } else if (no_null_default_yes) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(int.parse(k), e as bool)) ?? $initComment";
      } else if (no_null_default_no) {
        return _getValueWithException(
          "(Map<String, dynamic>.from(map['$name'] as Map)).map((k, e) => MapEntry(int.parse(k), e as bool))",
          name,
        );
      }
      return error;
    ...
    case EnumTypeVarable.map_int_string:
      if (yes_null_default_yes) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(int.parse(k), e as String)) ?? $initComment";
      } else if (yes_null_default_no) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(int.parse(k), e as String))";
      } else if (no_null_default_yes) {
        return "(Map<String, dynamic>.from(map['$name'] as Map)?)?.map((k, e) => MapEntry(int.parse(k), e as String)) ?? $initComment";
      } else if (no_null_default_no) {
        return _getValueWithException(
          "(Map<String, dynamic>.from(map['$name'] as Map)).map((k, e) => MapEntry(int.parse(k), e as String))",
          name,
        );
      }
      return error;
    ...
    case EnumTypeVarable.data:
      if (yes_null_default_yes) {
        ...
        // return "$nameObject.fromMap(Map<String, dynamic>.from(map['$name'] as Map),)";
      } else if (no_null_default_no) {
        return _getValueWithException(
          "$nameObject.fromMap(Map<String, dynamic>.from(map['$name'] as Map),)",
          name,
