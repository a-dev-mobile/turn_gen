...
//  *************************************
  ...
  factory Varable.fromMap(Map<dynamic, dynamic>? map) {
    ...
    return Varable(
      ...
      initValueDefault: map['initValueDefault'] != null
          ? map['initValueDefault'] as String
          : '',
      initValueComment: map['initValueComment'] != null
          ? map['initValueComment'] as String
          : '',
  ...
  factory Varable.fromJson(String source) => Varable.fromMap(
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.typeInList, typeInList) ||
